...
const getStatusText = (status) => {
  switch (status) {
    case 'available': return t('pages.pantry.status.available')
    case 'low': return t('pages.pantry.status.low')
    case 'expired': return t('pages.pantry.status.expired')
    default: return t('pages.pantry.status.unknown')
  }
}
